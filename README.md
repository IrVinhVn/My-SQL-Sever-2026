...
Bước 10: Thêm dữ liệu cá nhân (INSERT)
...
Bước 11: Cập nhật dữ liệu (UPDATE)
...
Bước 12: Trích xuất dữ liệu sang bảng mới (SELECT INTO)
...
Bước 14: Xóa dữ liệu có điều kiện (DELETE)
...
Bước 15: Kiểm tra kết quả sau khi xóa
...
Bước 17: Xóa Database và kiểm tra tệp vật lý
Thực hiện xóa cơ sở dữ liệu. Sau khi xóa thành công, kiểm tra lại thư mục lưu trữ (tại Bước 6) để xác nhận 2 file vật lý không còn tồn tại.
